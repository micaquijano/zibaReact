  ...
  return (
    <>
      ...
      <div id="layout-NavBar" className="NavBar-bg">
        <Link to="./">
          <img className="imgLogo" src="https://d3ugyf2ht6aenh.cloudfront.net/stores/227/495/themes/common/logo-680984998-1603467733-51b38fe7dbfe694f31ab0198426ff6471603467734-320-0.png?0"></img>
