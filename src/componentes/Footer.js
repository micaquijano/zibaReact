            ...
            <h3>Contactanos</h3>
              <li>
                <a href="https://www.facebook.com/">
                  <i className="bi bi-facebook "></i>ValkyryaProductos</a>
              </li>
              <li>
                <a href="https://www.twtter.com/">
                  <i className="bi bi-twitter"></i>ValkyryaProductos</a>
              </li>
              <li>
                <a href="https://www.instagram.com/"><i className="bi bi-instagram"></i>ValkyryaProductos</a>
              </li>
              <li>
                <a href="https://mail.google.com/"><i className="bi bi-envelope"></i>info@ValkyryaProductos.org</a>
              </li>
            </ul>
            <div>
